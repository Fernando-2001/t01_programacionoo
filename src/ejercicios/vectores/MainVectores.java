...
public class MainVectores {
	...
	public static void main(String[] args) {
		...
		// 3. Declarar un vector miVec[4] tipo char, y asignamos la letra A a la posicion 0 y 2.
		char miVec[] = new char [4];
		miVec[0] = 'A';
		miVec[2] = 'A';
		
		// 4. Declarar un vector miVec1[3] tipo byte, y asignamos el numero 0 a la posicion 0,1,2 y 3.
